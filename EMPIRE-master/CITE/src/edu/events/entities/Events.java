...
private int place_dispo;
    ...
    public Events(String nom_event) {
        this.nom_event = nom_event;
    }

    public Events(String nom_event, String localisation_event, int prix_event, Date date_event, int place_dispo) {
        this.nom_event = nom_event;
    ...
    public Events(int id_event, String nom_event, String localisation_event, int prix_event, Date date_event, int place_dispo) {
    ...
    public Events(int id_event, String nom_event, int prix_event) {
        this.id_event = id_event;
        this.nom_event = nom_event;
        this.prix_event = prix_event;
    }
    ...
    public Events(int id_event, String nom_event, String localisation_event, int prix_event) {
        this.id_event = id_event;
        this.nom_event = nom_event;
        this.localisation_event = localisation_event;
        this.prix_event = prix_event;
    ...
    public Events(int id_event, String nom_event) {
        this.id_event = id_event;
        this.nom_event = nom_event;
    }

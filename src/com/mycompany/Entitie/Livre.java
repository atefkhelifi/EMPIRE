...
public class Livre {
    ...
    public Livre(int id_livre, String nom_livre, String auteur_livre, String etat_livre, String domaine_livre, int nombreExemplaire) {
    ...
    public Livre(String nom_livre, String auteur_livre, String etat_livre, String domaine_livre, int nombreExemplaire) {
        this.nom_livre = nom_livre;
        this.auteur_livre = auteur_livre;
        this.etat_livre = etat_livre;
        this.domaine_livre = domaine_livre;
    ...
    public Livre(int id_livre, String nom_livre) {
        this.id_livre = id_livre;
        this.nom_livre = nom_livre;
    }
